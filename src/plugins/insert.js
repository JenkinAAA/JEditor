...
const CHEVRON_SVG = '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 6 15 12 9 18"></polyline></svg>'
const TABLE_ICON = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="5" width="16" height="14" rx="1"/><path d="M4 10h16"/><path d="M9 5v14"/><path d="M15 5v14"/></svg>'
...
function createTablePicker(editor, context) {
    ...
    const paintGrid = () => {
        Array.from(grid.children).forEach((cell, index) => {
            ...
            cell.classList.toggle('is-active', activeCols > 0 && activeRows > 0 && col <= activeCols && row <= activeRows)
        })
...
function createItem(item, popover, context) {
